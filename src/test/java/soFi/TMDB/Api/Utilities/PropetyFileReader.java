...
public  class PropetyFileReader {
	...
	public  static String propertyFileReader(String propertyFile,  String key){
	 ...
	 */	
	public static void printAllProperties(String propertyFile){

		FileInputStream fileInput = null;
		try {
			fileInput = new FileInputStream(Config.environmentFileLocationProperty);
